package com.duvanlabrador.pizza.util;

public class Constants {
    private Constants() {
        throw new IllegalStateException("Utility class");
    }
    public static final String SWAGGER_TITLE_MESSAGE = "Request Pizza API";
    public static final String SWAGGER_DESCRIPTION_MESSAGE = "This is a API for Pizzas";
    ...
    public static final String SWAGGER_CONTACT_URL_MESSAGE = "https://github.com/DuvanLabrador10/pizzas";
